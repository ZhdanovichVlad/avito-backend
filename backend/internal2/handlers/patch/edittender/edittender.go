...
import (
	...
	"avitoTest/backend/internal2/handlers"
...
// EditTenderH Handler to edit the tender
func EditTenderH(server editTender) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "internal2.patch.EditTenderH"
		...
		// The following two entries are necessary to make the answer conform to the terms of reference.
