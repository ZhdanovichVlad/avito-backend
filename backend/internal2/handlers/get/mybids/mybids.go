...
// GetMyBids Handler to retrieve a list of bids according to specified conditions. The нandler supports pagination
func GetMyBids(server getMyBidsI) http.HandlerFunc {
	return func(writer http.ResponseWriter, request *http.Request) {
		const op = "backend.internal2.handlers.get.GetMyBids"
