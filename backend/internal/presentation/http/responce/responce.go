...
// AnswerError generates and records the error in log and ResponseWriter
...
// AnswerSuccess generates and records successful response in log and ResponseWriter
