...
func (server NewTenderApplication) NewTender(tender *tender.Tender) (httpCode int, err error) {
	...
	httpCode, err = server.DataValidator.FullExist(tender.CreatorUsername, tender.OrganizationId)
	if err != nil {
